...
if __name__ == '__main__':
    ...
    video_list = pd.DataFrame({'video_1': ['Ses01F_impro01_F', 'Ses01F_impro02_F', 'Ses01F_impro03_F', 'Ses01F_impro04_F', 'Ses01F_impro05_F','Ses04F_impro02_F'],
                               'video_2': ['Ses01F_impro01_M', 'Ses01F_impro02_M', 'Ses01F_impro03_M', 'Ses01F_impro04_M', 'Ses01F_impro05_M','Ses04F_impro02_M']})
    for i in range(len(video_list)):
        video_1 = video_list.video_1[i]
        video_2 = video_list.video_2[i]
        start = datetime.now()
        m3.weave_vpa(video_1=video_1, video_2=video_2,
                  delay=0, tone=1, speech_rate=0,
