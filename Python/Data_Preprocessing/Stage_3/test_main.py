...
class Test_Narrative:
    ...
    talkturn_lookup = os.path.join(parallel_run_settings['test_file_path'], 'test.csv')
    talkturn_lookup2 = os.path.join(parallel_run_settings['test_file_path'], 'test2.csv')
